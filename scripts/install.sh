...
#
# Usage:
#   curl -fsSL https://raw.githubusercontent.com/Iwakishirokoshu/Hermes-Unlocked-Cloak-Edition-0.19/main/scripts/install.sh | bash
#
# Or with options:
...
# Configuration
REPO_URL_SSH="git@github.com:Iwakishirokoshu/Hermes-Unlocked-Cloak-Edition-0.19.git"
REPO_URL_HTTPS="https://github.com/Iwakishirokoshu/Hermes-Unlocked-Cloak-Edition-0.19.git"
...
detect_os() {
    case "$(uname -s)" in
        ...
        CYGWIN*|MINGW*|MSYS*)
            ...
            log_info "  iex (irm https://raw.githubusercontent.com/Iwakishirokoshu/Hermes-Unlocked-Cloak-Edition-0.19/main/scripts/install.ps1)"
            exit 1
            ;;
        *)
            OS="unknown"
