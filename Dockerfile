...
# Cloak Edition runtime dependencies. The browser itself is owned by
# CloakBrowser-Manager; these packages only create and drive Manager profiles
# through its authenticated CDP endpoint, so no second browser download occurs.
