...
const BUILTIN_NAV_REST: NavItem[] = [
  ...
  { path: "/cloak", labelKey: "cloak", label: "Cloak", icon: Eye },
...
export default function App() {
  ...
  const isCloakRoute = pathname === "/cloak" || pathname === "/cloak/";
          ...
          <PageHeaderProvider pluginTabs={pluginTabMeta}>
            <div
              className={cn(
                ...
                (isDocsRoute || isCloakRoute) && "min-h-0 flex-1",
              )}
            >
              ...
              <div
                className={cn(
                  ...
                  (isDocsRoute || isCloakRoute || isChatRoute) &&
